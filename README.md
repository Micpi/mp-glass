...
- Frontend : stratégie MP Nexus Dashboard, vue responsive, carte lumière marche/arrêt et luminosité, fallback, editor, et **MP Nexus Studio** à deux profondeurs : mode essentiel en trois étapes (Analyser, Pièces, Style) pour obtenir un dashboard sans rien connaître de Home Assistant, mode expert pour tout régler, sélectionner des équipements en masse, importer/exporter un projet et annuler une modification.
