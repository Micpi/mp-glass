...
**État : version de développement 0.9.1, installable depuis HACS comme dépôt personnalisé.** Le parcours lumière et le Studio ont été validés sur HA 2026.9.1. Le plan 3D et l’import Gemini sont testés localement ; l’appel Gemini réel reste à valider.
...
- Français, anglais et russe : chaque utilisateur choisit sa langue avec le petit drapeau du dashboard (à côté de l’horloge, ou au bout de la navigation sur téléphone). Le choix vaut pour le dashboard, le plan 3D et le Studio, sur tous ses appareils ; tant qu’il n’a rien choisi, MP Glass suit la langue de son profil Home Assistant.
