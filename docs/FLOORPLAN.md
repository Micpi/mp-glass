...
1. Installer MP Glass 0.2.2 et redémarrer HA. Si une ressource Lovelace historique pointe vers `mp-glass-r14.js`, la remplacer par `/mp_glass_static/mp-glass-bootstrap.js?v=0.2.2`, puis recharger le navigateur.
