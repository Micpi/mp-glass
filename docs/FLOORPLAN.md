...
- **Vue enregistrée** : garder le doigt (ou la souris) sur **Recentrer** une demi-seconde — ou un clic droit — propose d’enregistrer la maison telle qu’elle est cadrée. Après validation, le niveau s’ouvre sur cette vue et le bouton l’y ramène, signalé par un point bleu ; l’appui long propose alors de la remplacer ou de l’oublier. Un niveau garde sa propre vue ; **Vue de dessus** garde le cadrage standard. Ces vues sont enregistrées dans le navigateur (`localStorage`), pas dans le plan : elles ne changent rien pour les autres appareils ni pour les autres utilisateurs.
...
- Deux pièces séparées sur le plan par l’épaisseur d’un mur (moins de 30 cm) partagent une seule cloison, au milieu de cette épaisseur, au lieu d’avoir chacune la sienne. Seul l’affichage change : le plan enregistré et les surfaces restent ceux du Studio.
...
Chaque volet associé apparaît sous le nom de sa pièce avec un petit tablier et son pourcentage **ouvert** : 0 % fermé, 100 % ouvert. Ce symbole est un indicateur d’équipement, pas une fenêtre localisée automatiquement sur un mur. La fiche de pièce propose ouvrir, arrêter, fermer et choisir la position selon les fonctions exposées par l’entité. Une position inconnue n’est pas remplacée par 100 %. Commandes natives HA, équipement associé uniquement ; les refus sont affichés. [Convention Home Assistant](https://www.home-assistant.io/integrations/cover/).
...
- **Aimantation** : le bouton permet de désactiver ou réactiver cette aide. Lorsqu’elle est active, chaque bord, et chaque point sur chacun de ses deux axes, se colle à moins de 10 px d’écran d’un mur dessiné, d’un bord ou d’un angle d’une autre pièce, ou des points voisins du même contour : les côtés restent d’équerre sans viser au pixel près.
