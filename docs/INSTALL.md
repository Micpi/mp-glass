...
Si le module n'apparaît pas après installation : recharger complètement le navigateur. Le backend charge le bootstrap de strategy avant Lovelace, puis le bundle principal à la demande. Pour utiliser seulement la carte en mode MANUAL, charger `/mp_glass_static/mp-glass.js?v=0.2.6` (version installée) comme ressource module dans l'UI Lovelace après installation du composant.
