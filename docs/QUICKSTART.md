...
MP Nexus Studio crée le dashboard MP Nexus à sa première ouverture. Ouvrir la vue Salon, toucher Allumer et observer l'état serveur. Une lumière déclarant brightness offre un slider ; une lumière onoff n'en offre aucun. Détails ouvre la fenêtre MP Nexus de l'équipement, dans le thème du dashboard ; son pied de page rend la main au dialogue Home Assistant pour l'historique et les réglages.
