...
Installer selon INSTALL, ouvrir MP Nexus, lancer l'analyse. La lumière reçoit une classification issue du domaine et les capabilities issues des attributs HA. Une entité sans pièce apparaît dans « Sans pièce ». Sélectionner la pièce puis enregistrer.
