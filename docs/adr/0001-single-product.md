...
Conséquences : build avant packaging obligatoire ; JS public exclusivement statique ; projet via API authentifiée. Dépôt produit avec un seul domaine ; le monorepo parent n'est pas une cible HACS valide pour MP Glass. Revoir si le frontend doit avoir un cycle indépendant. Source : https://hacs.xyz/docs/publish/integration/
